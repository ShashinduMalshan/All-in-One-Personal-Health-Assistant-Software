  ...
  Widget _buildRecentActivities() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        _buildActivityItem("Logged breakfast", "10:30 AM", Icons.restaurant, Colors.orange, "Healthy choice! 🥗"),
        _buildActivityItem("15 min meditation", "9:15 AM", Icons.self_improvement, Colors.purple, "Inner peace ✨"),
        _buildActivityItem("Drank water", "8:45 AM", Icons.water_drop, Colors.blue, "Stay hydrated! 💧"),
      ],
    );
  }
